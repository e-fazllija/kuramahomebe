...
namespace BackEnd.Migrations
{
    ...
    [Migration("20260219112129_ChatSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Entities.ConversationParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BackEnd.Entities.Message", b =>
                {
                    ...
                    b.HasIndex("ConversationId", "CreationDate")
                        .HasDatabaseName("IX_Message_ConversationId_CreationDate");

                    b.ToTable("Messages");
                });

            modelBuilder.Entity("BackEnd.Entities.MessageAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BackEnd.Entities.MessageReadStatus", b =>
                {
                    b.Property<int>("MessageId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BackEnd.Entities.Message", b =>
                {
                    ...
                    b.HasOne("BackEnd.Entities.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("BackEnd.Entities.MessageAttachment", b =>
                {
                    b.HasOne("BackEnd.Entities.Message", "Message")
